...
- (UIImage *)createSmallThumbnailPicWithSize:(NSInteger)thumbnailSize
    ...
    UIImage *resizedImage = [self resizeImage:UIViewContentModeScaleAspectFill
													  :CGSizeMake(thumbnailSize, thumbnailSize)
										:quality];
    CGRect cropRect = CGRectMake(round((resizedImage.size.width - thumbnailSize) / 2),
                                 round((resizedImage.size.height - thumbnailSize) / 2),
                                 thumbnailSize,
                                 thumbnailSize);
    UIImage *croppedImage = [resizedImage cropImageBySize:cropRect];
    UIImage *transparentBorderImage = borderSize ? [croppedImage createImageWithBorder:borderSize] : croppedImage;
    return [transparentBorderImage createImageWithRoundCorners:cornerRadius :borderSize];
}
